  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <a href="#" class="" data-role="end">Skip All</a> <div class="btn-group ml-auto"> <a href="#" class="" data-role="prev">Prev</a> <a href="#" class="" data-role="next">Next</a> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> </div> </div>',
    ...
    Tour.prototype._template = function(step, i) {
      ...
      if (step.next < 0) {
        $next.addClass('disabled').prop('disabled', true).prop('tabindex', -1).html("<a href='#' data-role='end'>Done</a>");
      }
      if (!step.duration) {
        $resume.remove();
      }
